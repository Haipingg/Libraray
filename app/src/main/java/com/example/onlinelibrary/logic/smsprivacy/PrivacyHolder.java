package com.example.onlinelibrary.logic.smsprivacy;
...
public class PrivacyHolder {
	...
	private static com.example.onlinelibrary.logic.smsprivacy.PrivacyHolder instance;
	private String privacyUrl = "http://www.mob.com/about/policy";

	private PrivacyHolder() {}

	public static com.example.onlinelibrary.logic.smsprivacy.PrivacyHolder getInstance() {
		if (instance == null) {
			synchronized (com.example.onlinelibrary.logic.smsprivacy.PrivacyHolder.class) {
				if (instance == null) {
					instance = new com.example.onlinelibrary.logic.smsprivacy.PrivacyHolder();
				}
			}
		}
		return instance;
